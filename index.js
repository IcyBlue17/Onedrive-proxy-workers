//target
const upstream = 'xxxxxx-my.sharepoint.com'
const upstream_mobile = 'xxxxxx-my.sharepoint.com
//country blacklist
...
async function fetchAndApply(request) {
  ...
  if (blocked_region.includes(region)) {
    ...
    if (!content_type.includes('application/octet-stream')) {
      response = new Response('Access denied: Only file downloads are allowed.', { status: 403 });
      return response;
    } else {
